...
export interface ILevelsClient {
    ...
    updateLevel(id: number, command: UpdateLevelCommand): Observable<void>;
}
...
export class LevelsClient implements ILevelsClient {
    ...
    updateLevel(id: number, command: UpdateLevelCommand): Observable<void> {
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateLevel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateLevel(response_ as any);
                } catch (e) {
    ...
    protected processUpdateLevel(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
